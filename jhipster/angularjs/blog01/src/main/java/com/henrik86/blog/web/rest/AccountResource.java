...
import com.henrik86.blog.service.UserService;
import com.henrik86.blog.service.dto.UserDTO;
import com.henrik86.blog.web.rest.vm.KeyAndPasswordVM;
import com.henrik86.blog.web.rest.vm.ManagedUserVM;
import com.henrik86.blog.web.rest.util.HeaderUtil;
        ...
        return userRepository.findOneByLogin(managedUserVM.getLogin().toLowerCase())
            ...
            .orElseGet(() -> userRepository.findOneByEmail(managedUserVM.getEmail())
                ...
                .orElseGet(() -> {
                    ...
                    userService.createExtraInfo(user, managedUserVM.getPhone());
