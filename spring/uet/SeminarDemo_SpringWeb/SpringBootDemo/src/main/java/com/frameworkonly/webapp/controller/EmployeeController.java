...
public class EmployeeController {
	...
	@RequestMapping(value = { "/employees", "/savepage" }, method = RequestMethod.GET)
	...
	public String editRemoveEmployee(@PathVariable("operation") String operation, @PathVariable("empId") Long empId,
