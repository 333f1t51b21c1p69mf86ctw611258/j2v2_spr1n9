...
package de.codecentric.namespace.deviceservice.general;
 ...
 * generated in the de.codecentric.namespace.deviceservice.general package. 
...
public class ObjectFactory {
    ...
    private final static QName _ForecastReturn_QNAME = new QName("http://www.codecentric.de/namespace/deviceservice/general", "ForecastReturn");
    private final static QName _DeviceReturn_QNAME = new QName("http://www.codecentric.de/namespace/deviceservice/general", "DeviceReturn");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: de.codecentric.namespace.deviceservice.general
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.codecentric.de/namespace/deviceservice/general", name = "ForecastReturn")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.codecentric.de/namespace/deviceservice/general", name = "DeviceReturn")
