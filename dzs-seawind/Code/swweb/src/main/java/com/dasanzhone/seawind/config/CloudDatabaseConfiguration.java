package com.dasanzhone.seawind.config;
...
@Configuration
@EnableMongoRepositories("com.dasanzhone.seawind.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        mongobee.setChangeLogsScanPackage("com.dasanzhone.seawind.config.dbmigrations");
